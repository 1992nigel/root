...
var set_stage_game_leaveBottom = function set_stage_game_leaveBottom() {
  ...
  if (document.getElementById('set') != null) {
    var _set2 = document.getElementById('set');
  ...
  if (document.getElementById('scene') != null) {
    var _scene2 = document.getElementById('scene');
...
var set_stage_game_end = function set_stage_game_end() {
  if (document.getElementById('set') != null) {
    var _set3 = document.getElementById('set');
  ...
  if (document.getElementById('scene') != null) {
    var _scene3 = document.getElementById('scene');
...
var sequence_stage_game_ending = function sequence_stage_game_ending() {
  // 24/fps loop !! initial !!
  (function () {
    var interval = 0;
...
var shot_action_single_vomiting = function shot_action_single_vomiting() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_logo_action_blinking_only = function shot_action_logo_action_blinking_only() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_user_screen_1 = function shot_action_user_screen_1() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_user_screen_2 = function shot_action_user_screen_2() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_user_screen_3 = function shot_action_user_screen_3() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_user_screen_5 = function shot_action_user_screen_5() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_user_screen_5_leave = function shot_action_user_screen_5_leave() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var sequence_shot_action_user_screen_5_leave = function sequence_shot_action_user_screen_5_leave() {
  // 24/fps loop !! initial !!
  (function () {
    var interval = 0;
    var play = setInterval(function () {
      if (interval == 24 * 0) {
        if (document.getElementById('shots') != null) {
          if (dev_mode) {
            checkmark += 1; //alert('shot_TEXT_load_ACTION_leaveBottom');
...
var shot_action_game_help = function shot_action_game_help() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var add_events_after_game_start = function add_events_after_game_start() {
...
var sequence_shot_action_game_start = function sequence_shot_action_game_start() {
  alert('sequence_shot_action_game_start'); // 24/fps loop !! initial !!
...
var shot_action_user_screen_6 = function shot_action_user_screen_6() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var sequence_home = function sequence_home() {
  (function () {
    var interval = 0;
    var play = setInterval(function () {
      if (interval == 24 * 0) {
...
var sequence_inital = function sequence_inital() {
  (function () {
    var interval = 0;
    var play = setInterval(function () {
      if (interval == 24 * 0) {
...
var sequence_user = function sequence_user() {
  (function () {
    var interval = 0;
    var play = setInterval(function () {
      if (interval == 24 * 0) {
...
var add_events_after_sequence_inital = function add_events_after_sequence_inital() {
