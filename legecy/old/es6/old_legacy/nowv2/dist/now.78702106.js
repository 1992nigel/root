...
var wp_content = function wp_content() {
...
},{"../index.js":3}],229:[function(require,module,exports) {
'use strict';
...
},{"../index.js":3,"./elements":233}],230:[function(require,module,exports) {
'use strict';
...
},{"../index.js":3}],231:[function(require,module,exports) {
'use strict';
...
},{"./elements":233}],232:[function(require,module,exports) {
'use strict';
...
},{"../index.js":3}],234:[function(require,module,exports) {
'use strict';
...
},{"../index.js":3}],235:[function(require,module,exports) {
'use strict';
...
var Handle_ui = function Handle_ui() {
    ...
    if (state.animation.instances.loaded && !state.animation.instances.start && !state.animation.instances.learn && !state.animation.instances.hide) {
        if (document.getElementById('layer_fg_2_motion') != null) {
            document.getElementById('layer_fg_2_motion').classList = 'position_absolute bottom_0 top_0 left_0 right_0 width_33 height_33 margin_auto float_left';
        }
    }
    ...
    if (state.animation.instances.loaded && state.animation.instances.start && !state.animation.instances.learn && !state.animation.instances.hide) {
        if (document.getElementById('layer_fg_2_motion') != null) {
            document.getElementById('layer_fg_2_motion').classList = 'position_absolute bottom_0 top_0 left_0 width_33 height_33 margin_auto float_left';
        }
    }
    ...
    if (state.animation.instances.loaded && !state.animation.instances.start && state.animation.instances.learn && !state.animation.instances.hide) {
        if (document.getElementById('layer_fg_2_motion') != null) {
            document.getElementById('layer_fg_2_motion').classList = 'position_absolute bottom_0 top_0 right_0 width_33 height_33 margin_auto float_left';
        }
    }
    ...
    if (state.animation.instances.loaded && !state.animation.instances.start && !state.animation.instances.learn && state.animation.instances.hide) {
        if (document.getElementById('layer_fg_2_motion') != null) {
            document.getElementById('layer_fg_2_motion').classList = 'position_absolute bottom_0 top_0 right_0 left_0 opacity_05 width_33 height_33 margin_auto float_left';
        }
    }
...
var HANDLE_animation_home = function HANDLE_animation_home() {
    ...
    state.ui.interaction.player_1.xaxis = -2;
...
},{"./partials/state":228,"./partials/functions":229,"./partials/events":230,"./partials/defaults":231,"./partials/components":232,"./partials/elements":233,"./partials/values":234,"./partials/ui":235}],236:[function(require,module,exports) {
