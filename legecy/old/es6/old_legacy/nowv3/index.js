            ...
            if ( (document.getElementById('element_input_filter')) != null) {
                ...
                if(document.getElementById('dashboard_posts') != null) {
                    ...
                    for (var i = 0; i < array_gnougn_library.length; i++) {
                        ...
                        document.getElementById('dashboard_posts').appendChild(imported_functions.Generate_new_fragment.appendChild(
                          imported_functions.Generate_new_li(filtered_array_gnougn_library[i])
                            )
                        )
                    }
                ...
                if(document.getElementById('about_posts') != null) {
                    ...
                    for (var i = 0; i < array_gnougn_library.length; i++) {
                        // console.log(filtered_array_gnougn_library[i]);
                        document.getElementById('about_posts').appendChild(imported_functions.Generate_new_fragment.appendChild(
                          imported_functions.Generate_new_li(filtered_array_gnougn_library[i])
                            )
                        )
                    }
...
let Handle_EventListeners = () => {
        ...
        if (document.getElementById('element_user_login') != null) {
            document.getElementById('element_user_login').addEventListener('click', (event) => {
...
let HANDLE_animation_gui_cursor_moved = () => {
...
let HANDLE_animation_gui_key_pressed = () => {
...
let HANDLE_animation_paint_drop_hand = () => {
    ...
    (function() {
        ...
        setInterval(
            ...
            function() {
                    ...
                    let MANIPULATED = document.getElementById('paint_animation_svg_2');
...
let HANDLE_animation_loading_player_motion = () => {
    ...
    (function() {
        ...
        setInterval(
            ...
            function() {
                    ...
                    let MANIPULATED = document.getElementById('wall');
...
let HANDLE_animation_cursor_moved = () => {
...
let HANDLE_animation_key_pressed = () => {
...
let HANDLE_animation_back_to_key_pressed = () => {
...
let HANDLE_animation_back_to_up = () => {
    document.getElementById('component_app_scrolling').scrollTop = 0;
    document.getElementById('component_app_scrolling').classList.add('overflow_hidden');
    document.getElementById('component_app_scrolling').classList.remove('overflow_y');
};

let HANDLE_animation_scrolled = () => {
...
let HANDLE_animation_scrolled_up = () => {
...
let HANDLE_animation_scrolled_down = () => {
...
let HANDLE_animation_gui_logo_type = () => {
        ...
        (function() {
            ...
            setInterval(
                function() {
                    let MANIPULATED = document.getElementById('gui_logo_type_svg');
...
export default {
    ...
    HANDLE_animation_key_pressed,
    HANDLE_animation_cursor_moved,
    HANDLE_animation_scrolled,
    HANDLE_animation_scrolled_up,
    HANDLE_animation_scrolled_down,
    sound1,
    event_wheel_up,
    event_wheel_down,
    check_door
