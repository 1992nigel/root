...
var handle_if_AUTH_checked_CLICK_SCENE_2 = function handle_if_AUTH_checked_CLICK_SCENE_2() {
  alert('handle_if_AUTH_checked_CLICK_SCENE_2'); // 24/fps loop
...
var handle_if_AUTH_checked_CLICK_SCENE_3 = function handle_if_AUTH_checked_CLICK_SCENE_3() {
  alert('handle_if_AUTH_checked_CLICK_SCENE_3'); // 24/fps loop
...
var shot_at_animation_begin_1 = function shot_at_animation_begin_1() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_at_animation_begin_2 = function shot_at_animation_begin_2() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_at_animation_begin_3 = function shot_at_animation_begin_3() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_at_animation_begin_4 = function shot_at_animation_begin_4() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_at_animation_begin_5 = function shot_at_animation_begin_5() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_at_animation_begin_6 = function shot_at_animation_begin_6() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_to_scene_facer_button = function shot_to_scene_facer_button() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
  ...
  element.addEventListener("click", function (event) {
    handle_if_AUTH_checked_CLICK_SCENE_shot_to_scene_facer_button();
  });
  document.getElementById('shots').appendChild(element);
};
...
var action_shot_single_1 = function action_shot_single_1() {
  // 24/fps loop
  (function () {
    var interval = 0;
    var play = setInterval(function () {
...
var action_shot_mix = function action_shot_mix() {
  // 24/fps loop
  (function () {
    var interval = 0;
    var play = setInterval(function () {
...
var shot_to_scene_2 = function shot_to_scene_2() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_mid_of_authing = function shot_mid_of_authing() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_start_of_authing_facer_button = function shot_start_of_authing_facer_button() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
...
var shot_end_of_authing_facer_button = function shot_end_of_authing_facer_button() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
  element.classList = "width_100 height_100 top_0 bottom_0 left_0 right_0 margin_auto position_absolute";
  element.innerHTML = "\n        <div id=\"facer_1_final\"></div>\n        <div id=\"facer_2_final\"></div>\n        <div id=\"facer_buttons_final\"></div>\n    ";
  document.getElementById('shots').appendChild(element); // facer_buttons

  if (document.getElementById('facer_buttons_final') != null) {
    document.getElementById('facer_buttons_final').addEventListener("click", function (event) {
      alert('yup facer_buttons_final');
      state.interaction.player_1.cycles.walking = !state.interaction.player_1.cycles.walking;
    });
  }
};

var handle_if_AUTH_checked_CLICK_SCENE_shot_to_scene_facer_button = function handle_if_AUTH_checked_CLICK_SCENE_shot_to_scene_facer_button() {
  alert('handle_if_AUTH_checked_CLICK_SCENE_shot_to_scene_facer_button'); // 24/fps loop
  ...
  (function () {
    ...
    var play = setInterval(function () {
      if (interval == 0) {
        if (document.getElementById('shots') != null) {
          shot_start_of_authing_facer_button();
        }
      ...
      if (interval == 24 * 1) {
        // the final shot of opening scene
        if (document.getElementById('shots') != null) {
          shot_end_of_authing_facer_button();
        }
  ...
  (function () {
    ...
    setInterval(function () {
      ...
      if (document.getElementById('gui_stage_tv') != null) {
        if (state.interaction.bridge_1.stance == 0) {
          if (state.interaction.bridge_1.angle == 0) {
            document.getElementById('gui_stage_tv').classList = ' width_100 height_100 gui_character_face_left_shadow_' + state.interaction.bridge_1.frame + ' position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_1.angle == 1) {
            document.getElementById('gui_stage_tv').classList = ' width_100 height_100 gui_character_face_left_shadow_' + state.interaction.bridge_1.frame + ' position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_1.frame == 4) {
          state.interaction.bridge_1.frame = 0;
        }

        ;
        state.interaction.bridge_1.frame += 1; // automated motion

        if (state.interaction.bridge_1.cycles.walking == true) {
          // stance: up
          if (state.interaction.bridge_1.stance == 3) {
            // player walking and pause
            if (state.interaction.bridge_1.clientY < 3) {
              state.interaction.bridge_1.clientY += 1 / 32;
            }
          ...
          if (state.interaction.bridge_1.stance == 2) {
            // player walking and pause
            if (state.interaction.bridge_1.clientY > -4) {
              state.interaction.bridge_1.clientY -= 1 / 32;
            }
          ...
          if (state.interaction.bridge_1.stance == 1) {
            // player walking and pause
            if (state.interaction.bridge_1.clientX < 8) {
              state.interaction.bridge_1.clientX += 1 / 32;
            }
          ...
          if (state.interaction.bridge_1.stance == 0) {
            // player walking and pause
            if (state.interaction.bridge_1.clientX > 0) {
              state.interaction.bridge_1.clientX -= 1 / 32;
            }
        ...
        if (state.interaction.bridge_1.clientX <= 0 && state.interaction.bridge_1.cycles.walking == true) {
          state.interaction.bridge_1.clientX = 0; //state.interaction.bridge_1.cycles.walking = false;
          // reset face

          state.interaction.bridge_1.stance = 1; // auto walk
        ...
        if (state.interaction.bridge_1.clientX >= 7 && state.interaction.bridge_1.cycles.walking == true) {
          state.interaction.bridge_1.clientX = 7; //state.interaction.bridge_1.cycles.walking = false;
          // reset face

          state.interaction.bridge_1.stance = 0; // auto walk
        ...
        gui_stage_tv.style = 'height: ' + state.interaction.bridge_1.height * (tiny_height / 8) + 'px;' + 'width: ' + state.interaction.bridge_1.width * (tiny_width / 8) + 'px;' + 'bottom: ' + state.interaction.bridge_1.clientY * (tiny_height / 8) + 'px;' + 'left: ' + state.interaction.bridge_1.clientX * (tiny_width / 8) + 'px;';
      }

      ;

      if (document.getElementById('gui_stage_lights') != null) {
        if (state.interaction.bridge_2.stance == 0) {
          if (state.interaction.bridge_2.angle == 0) {
            document.getElementById('gui_stage_lights').classList = ' width_100 height_100 gui_character_face_left_shadow_' + state.interaction.bridge_2.frame + ' position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_2.angle == 1) {
            document.getElementById('gui_stage_lights').classList = ' width_100 height_100 gui_character_face_left_shadow_' + state.interaction.bridge_2.frame + ' position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_2.frame == 4) {
          state.interaction.bridge_2.frame = 0;
        }

        ;
        state.interaction.bridge_2.frame += 1; // automated motion

        if (state.interaction.bridge_2.cycles.walking == true) {
          // stance: up
          if (state.interaction.bridge_2.stance == 3) {
            // player walking and pause
            if (state.interaction.bridge_2.clientY < 3) {
              state.interaction.bridge_2.clientY += 1 / 32;
            }
          ...
          if (state.interaction.bridge_2.stance == 2) {
            // player walking and pause
            if (state.interaction.bridge_2.clientY > -4) {
              state.interaction.bridge_2.clientY -= 1 / 32;
            }
          ...
          if (state.interaction.bridge_2.stance == 1) {
            // player walking and pause
            if (state.interaction.bridge_2.clientX < 8) {
              state.interaction.bridge_2.clientX += 1 / 32;
            }
          ...
          if (state.interaction.bridge_2.stance == 0) {
            // player walking and pause
            if (state.interaction.bridge_2.clientX > 0) {
              state.interaction.bridge_2.clientX -= 1 / 32;
            }
        ...
        if (state.interaction.bridge_2.clientX <= 0 && state.interaction.bridge_2.cycles.walking == true) {
          state.interaction.bridge_2.clientX = 0; //state.interaction.bridge_2.cycles.walking = false;
          // reset face

          state.interaction.bridge_2.stance = 1; // auto walk
        ...
        if (state.interaction.bridge_2.clientX >= 7 && state.interaction.bridge_2.cycles.walking == true) {
          state.interaction.bridge_2.clientX = 7; //state.interaction.bridge_2.cycles.walking = false;
          // reset face

          state.interaction.bridge_2.stance = 0; // auto walk
        ...
        gui_stage_lights.style = 'height: ' + state.interaction.bridge_2.height * (tiny_height / 8) + 'px;' + 'width: ' + state.interaction.bridge_2.width * (tiny_width / 8) + 'px;' + 'bottom: ' + state.interaction.bridge_2.clientY * (tiny_height / 8) + 'px;' + 'left: ' + state.interaction.bridge_2.clientX * (tiny_width / 8) + 'px;';
      }

      ;

      if (document.getElementById('mark') != null) {
        if (state.interaction.bridge_3.stance == 0) {
          if (state.interaction.bridge_3.angle == 0) {
            document.getElementById('mark').classList = ' width_100 height_100 gui_character_face_left_shadow_' + state.interaction.bridge_3.frame + ' position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_3.angle == 1) {
            document.getElementById('mark').classList = ' width_100 height_100 gui_character_face_left_shadow_' + state.interaction.bridge_3.frame + ' position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_3.frame == 4) {
          state.interaction.bridge_3.frame = 0;
        }

        ;
        state.interaction.bridge_3.frame += 1; // automated motion

        if (state.interaction.bridge_3.cycles.walking == true) {
          // stance: up
          if (state.interaction.bridge_3.stance == 3) {
            // player walking and pause
            if (state.interaction.bridge_3.clientY < 3) {
              state.interaction.bridge_3.clientY += 1 / 32;
            }
          ...
          if (state.interaction.bridge_3.stance == 2) {
            // player walking and pause
            if (state.interaction.bridge_3.clientY > -4) {
              state.interaction.bridge_3.clientY -= 1 / 32;
            }
          ...
          if (state.interaction.bridge_3.stance == 1) {
            // player walking and pause
            if (state.interaction.bridge_3.clientX < 8) {
              state.interaction.bridge_3.clientX += 1 / 32;
            }
          ...
          if (state.interaction.bridge_3.stance == 0) {
            // player walking and pause
            if (state.interaction.bridge_3.clientX > 0) {
              state.interaction.bridge_3.clientX -= 1 / 32;
            }
        ...
        if (state.interaction.bridge_3.clientX <= 0 && state.interaction.bridge_3.cycles.walking == true) {
          state.interaction.bridge_3.clientX = 0; //state.interaction.bridge_3.cycles.walking = false;
          // reset face

          state.interaction.bridge_3.stance = 1; // auto walk
        ...
        if (state.interaction.bridge_3.clientX >= 7 && state.interaction.bridge_3.cycles.walking == true) {
          state.interaction.bridge_3.clientX = 7; //state.interaction.bridge_3.cycles.walking = false;
          // reset face

          state.interaction.bridge_3.stance = 0; // auto walk
        ...
        mark.style = 'height: ' + state.interaction.bridge_3.height * (tiny_height / 8) + 'px;' + 'width: ' + state.interaction.bridge_3.width * (tiny_width / 8) + 'px;' + 'bottom: ' + state.interaction.bridge_3.clientY * (tiny_height / 8) + 'px;' + 'left: ' + state.interaction.bridge_3.clientX * (tiny_width / 8) + 'px;';
      }

      ; // shot 1

      if (document.getElementById('shot_1_character_1') != null) {
        if (state.interaction.bridge_4.stance == 0) {
          if (state.interaction.bridge_4.angle == 0) {
            document.getElementById('shot_1_character_1').classList = ' width_50 height_50 top_0 right_0 bottom_0 left_0 gui_character_face_left_shadow_' + state.interaction.bridge_4.frame + ' position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_4.angle == 1) {
            document.getElementById('shot_1_character_1').classList = ' width_50 height_50 top_0 right_0 bottom_0 left_0 gui_character_face_left_shadow_' + state.interaction.bridge_4.frame + ' position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_4.frame == 4) {
          state.interaction.bridge_4.frame = 0;
        }

        ;
        state.interaction.bridge_4.frame += 1;
        /*
        // automated motion
        if ( state.interaction.bridge_4.cycles.walking == true) {
             // stance: up
            if ( state.interaction.bridge_4.stance == 3 ) {
                 
                // player walking and pause
                if (state.interaction.bridge_4.clientY < 3) {
                    state.interaction.bridge_4.clientY += (1/32);
                };
            };
             // stance: down
            if ( state.interaction.bridge_4.stance == 2 ) {
                 // player walking and pause
                if (state.interaction.bridge_4.clientY > -4) {
                    state.interaction.bridge_4.clientY -= (1/32);
                };
            };
             // stance: right
            if ( state.interaction.bridge_4.stance == 1 ) {
                // player walking and pause
                if (state.interaction.bridge_4.clientX < 8) {
                    state.interaction.bridge_4.clientX += (1/32);
                };
            };
             // stance: left
            if ( state.interaction.bridge_4.stance == 0 ) {
                 // player walking and pause
                if (state.interaction.bridge_4.clientX > 0) {
                    state.interaction.bridge_4.clientX -= (1/32);
                };
            };
        };
         // left
        if ( state.interaction.bridge_4.clientX <= 0 && state.interaction.bridge_4.cycles.walking == true ) {
            state.interaction.bridge_4.clientX = 0;
            //state.interaction.bridge_4.cycles.walking = false;
             // reset face
            state.interaction.bridge_4.stance = 1;
             // auto walk
            state.interaction.bridge_4.clientX += (1/32);
        };
         // right
        if ( state.interaction.bridge_4.clientX >= 7 && state.interaction.bridge_4.cycles.walking == true ) {
            state.interaction.bridge_4.clientX = 7;
            //state.interaction.bridge_4.cycles.walking = false;
             // reset face
            state.interaction.bridge_4.stance = 0;
             // auto walk
            state.interaction.bridge_4.clientX -= (1/32);
        };
         // automated moving
        ...
        shot_1_character_1.style =
            'height: ' + (state.interaction.bridge_4.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_4.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_4.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_4.clientX * (tiny_width / 8)) + 'px;';
        */
      }
      ...
      if (document.getElementById('shot_1_character_2') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_1_character_2').classList = ' width_50 height_50 top_0 left_0 bottom_0 right_0 gui_logo_type_' + state.interaction.bridge_5.frame + ' position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_5.angle == 1) {
            document.getElementById('shot_1_character_2').classList = ' width_50 height_50 top_0 left_0 bottom_0 right_0 gui_logo_type_' + state.interaction.bridge_5.frame + ' position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_5.frame == 4) {
          state.interaction.bridge_5.frame = 0;
        }

        ;
        state.interaction.bridge_5.frame += 1;
        /*
        // automated motion
        if ( state.interaction.bridge_5.cycles.walking == true) {
             // stance: up
            if ( state.interaction.bridge_5.stance == 3 ) {
                 
                // player walking and pause
                if (state.interaction.bridge_5.clientY < 3) {
                    state.interaction.bridge_5.clientY += (1/32);
                };
            };
             // stance: down
            if ( state.interaction.bridge_5.stance == 2 ) {
                 // player walking and pause
                if (state.interaction.bridge_5.clientY > -4) {
                    state.interaction.bridge_5.clientY -= (1/32);
                };
            };
             // stance: right
            if ( state.interaction.bridge_5.stance == 1 ) {
                // player walking and pause
                if (state.interaction.bridge_5.clientX < 8) {
                    state.interaction.bridge_5.clientX += (1/32);
                };
            };
             // stance: left
            if ( state.interaction.bridge_5.stance == 0 ) {
                 // player walking and pause
                if (state.interaction.bridge_5.clientX > 0) {
                    state.interaction.bridge_5.clientX -= (1/32);
                };
            };
        };
         // left
        if ( state.interaction.bridge_5.clientX <= 0 && state.interaction.bridge_5.cycles.walking == true ) {
            state.interaction.bridge_5.clientX = 0;
            //state.interaction.bridge_5.cycles.walking = false;
             // reset face
            state.interaction.bridge_5.stance = 1;
             // auto walk
            state.interaction.bridge_5.clientX += (1/32);
        };
         // right
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
            state.interaction.bridge_5.clientX = 7;
            //state.interaction.bridge_5.cycles.walking = false;
             // reset face
            state.interaction.bridge_5.stance = 0;
             // auto walk
            state.interaction.bridge_5.clientX -= (1/32);
        };
         // automated moving
        ...
        shot_1_character_2.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
        */
      }
      ...
      if (document.getElementById('shot_1_character_3') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_1_character_3').classList = ' width_33 height_33 left_0 bottom_0 gui_text_continue position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let shot_1_character_3 = document.getElementById('shot_1_character_3');
        shot_1_character_3.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('shot_1_character_4') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_1_character_4').classList = ' width_33 height_33 left_0 bottom_0 right_0 gui_text_continue position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let shot_1_character_4 = document.getElementById('shot_1_character_4');
        shot_1_character_4.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('shot_1_character_5') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_1_character_5').classList = ' width_33 height_33 bottom_0 right_0 gui_text_continue position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let shot_1_character_5 = document.getElementById('shot_1_character_5');
        shot_1_character_5.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('shot_1_character_6') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_1_character_6').classList = ' width_33 height_33 top_0 left_0 right_0 gui_text_continue position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let shot_1_character_6 = document.getElementById('shot_1_character_6');
        shot_1_character_6.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('shot_2_character_2') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_2_character_2').classList = ' width_50 height_50 top_0 left_0 bottom_0 right_0 gui_logo_type_' + state.interaction.bridge_5.frame + ' position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let shot_2_character_2 = document.getElementById('shot_2_character_2');
        shot_2_character_2.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('shot_2_character_3') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_2_character_3').classList = ' width_33 height_33 left_0 top_0 bottom_0 gui_text_continue position_absolute margin_auto ';
          }
      ...
      if (document.getElementById('shot_2_character_4') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_2_character_4').classList = ' width_50 height_33 bottom_0 left_0 right_0 gui_buttons position_absolute margin_auto ';
          }
      ...
      if (document.getElementById('shot_2_character_5') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_2_character_5').classList = ' width_33 height_33 top_0 bottom_0 right_0 gui_text_continue position_absolute margin_auto ';
          }
      ...
      if (document.getElementById('shot_facer_button_character_1') != null) {
        if (state.interaction.bridge_4.stance == 0) {
          if (state.interaction.bridge_4.angle == 0) {
            document.getElementById('shot_facer_button_character_1').classList = ' width_50 height_50 top_0 right_0 bottom_0 left_0 gui_character_face_left_shadow_' + state.interaction.bridge_4.frame + ' position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_4.clientX >= 7 && state.interaction.bridge_4.cycles.walking == true ) {
         ...
         // automated moving
        let shot_facer_button_character_1 = document.getElementById('shot_facer_button_character_1');
        shot_facer_button_character_1.style =
            'height: ' + (state.interaction.bridge_4.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_4.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_4.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_4.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('shot_facer_button_character_2') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_facer_button_character_2').classList = ' width_50 height_50 top_0 left_0 bottom_0 right_0 gui_logo_type_' + state.interaction.bridge_5.frame + ' position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let shot_facer_button_character_2 = document.getElementById('shot_facer_button_character_2');
        shot_facer_button_character_2.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('shot_facer_button_character_3') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('shot_facer_button_character_3').classList = ' width_100 height_50 left_0 bottom_0 right_0 gui_text_continue position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let shot_facer_button_character_3 = document.getElementById('shot_facer_button_character_3');
        shot_facer_button_character_3.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('start_graphic_1') != null) {
        /*
        if (state.interaction.bridge_5.stance == 0) {
            if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('start_graphic_1').classList = ('width_100 height_100 top_0 bottom_0 left_0 right_0 gui_character_face_left_shadow_'+state.interaction.bridge_5.frame+ ' position_absolute margin_auto ');
        ...
        */
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let start_graphic_1 = document.getElementById('start_graphic_1');
        start_graphic_1.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('start_graphic_2') != null) {
        /*
        if (state.interaction.bridge_5.stance == 0) {
            if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('start_graphic_2').classList = ('width_100 height_100 top_0 bottom_0 left_0 right_0 gui_logo_type_'+state.interaction.bridge_5.frame+ ' position_absolute margin_auto ');
        ...
        */
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let start_graphic_2 = document.getElementById('start_graphic_2');
        start_graphic_2.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_5.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('begin_graphic') != null) {
        if (state.interaction.bridge_5.stance == 0) {
          if (state.interaction.bridge_5.angle == 0) {
            document.getElementById('begin_graphic').classList = ' width_100 height_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_5.clientX >= 7 && state.interaction.bridge_5.cycles.walking == true ) {
         ...
         // automated moving
        let begin_graphic = document.getElementById('begin_graphic');
        begin_graphic.style =
            'height: ' + (state.interaction.bridge_5.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_5.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_5.clientY * (tiny_height / 8)) + 'px;' +
      ...
      if (document.getElementById('facer_buttons') != null) {
        if (state.interaction.bridge_6.stance == 0) {
          if (state.interaction.bridge_6.angle == 0) {
            document.getElementById('facer_buttons').classList = ' width_50 height_25 bottom_0 left_0 right_0 gui_buttons position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_6.angle == 1) {
            document.getElementById('facer_buttons').classList = ' width_50 height_25 bottom_0 left_0 right_0 gui_buttons position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_6.frame == 4) {
          state.interaction.bridge_6.frame = 0;
        }

        ;
        state.interaction.bridge_6.frame += 1;
        /*
        // automated motion
        if ( state.interaction.bridge_6.cycles.walking == true) {
             // stance: up
            if ( state.interaction.bridge_6.stance == 3 ) {
                 
                // player walking and pause
                if (state.interaction.bridge_6.clientY < 3) {
                    state.interaction.bridge_6.clientY += (1/32);
                };
            };
             // stance: down
            if ( state.interaction.bridge_6.stance == 2 ) {
                 // player walking and pause
                if (state.interaction.bridge_6.clientY > -4) {
                    state.interaction.bridge_6.clientY -= (1/32);
                };
            };
             // stance: right
            if ( state.interaction.bridge_6.stance == 1 ) {
                // player walking and pause
                if (state.interaction.bridge_6.clientX < 8) {
                    state.interaction.bridge_6.clientX += (1/32);
                };
            };
             // stance: left
            if ( state.interaction.bridge_6.stance == 0 ) {
                 // player walking and pause
                if (state.interaction.bridge_6.clientX > 0) {
                    state.interaction.bridge_6.clientX -= (1/32);
                };
            };
        };
         // left
        if ( state.interaction.bridge_6.clientX <= 0 && state.interaction.bridge_6.cycles.walking == true ) {
            state.interaction.bridge_6.clientX = 0;
            //state.interaction.bridge_6.cycles.walking = false;
             // reset face
            state.interaction.bridge_6.stance = 1;
             // auto walk
            state.interaction.bridge_6.clientX += (1/32);
        };
         // right
        if ( state.interaction.bridge_6.clientX >= 7 && state.interaction.bridge_6.cycles.walking == true ) {
            state.interaction.bridge_6.clientX = 7;
            //state.interaction.bridge_6.cycles.walking = false;
             // reset face
            state.interaction.bridge_6.stance = 0;
             // auto walk
            state.interaction.bridge_6.clientX -= (1/32);
        };
         // automated moving
        let facer_buttons = document.getElementById('facer_buttons');
        facer_buttons.style =
            'height: ' + (state.interaction.bridge_6.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_6.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_6.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_6.clientX * (tiny_width / 8)) + 'px;';
        */
      }
      ...
      if (document.getElementById('facer_1') != null) {
        if (state.interaction.bridge_7.stance == 0) {
          if (state.interaction.bridge_7.angle == 0) {
            document.getElementById('facer_1').classList = ' width_50 height_50 top_0 left_0 right_0 bottom_0 gui_character_face_left_shadow_' + state.interaction.bridge_7.frame + ' position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_7.angle == 1) {
            document.getElementById('facer_1').classList = ' width_50 height_50 top_0 left_0 right_0 bottom_0 gui_character_face_left_shadow_' + state.interaction.bridge_7.frame + ' position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_7.frame == 4) {
          state.interaction.bridge_7.frame = 0;
        }

        ;
        state.interaction.bridge_7.frame += 1;
        /*
        // automated motion
        if ( state.interaction.bridge_7.cycles.walking == true) {
             // stance: up
            if ( state.interaction.bridge_7.stance == 3 ) {
                 
                // player walking and pause
                if (state.interaction.bridge_7.clientY < 3) {
                    state.interaction.bridge_7.clientY += (1/32);
                };
            };
             // stance: down
            if ( state.interaction.bridge_7.stance == 2 ) {
                 // player walking and pause
                if (state.interaction.bridge_7.clientY > -4) {
                    state.interaction.bridge_7.clientY -= (1/32);
                };
            };
             // stance: right
            if ( state.interaction.bridge_7.stance == 1 ) {
                // player walking and pause
                if (state.interaction.bridge_7.clientX < 8) {
                    state.interaction.bridge_7.clientX += (1/32);
                };
            };
             // stance: left
            if ( state.interaction.bridge_7.stance == 0 ) {
                 // player walking and pause
                if (state.interaction.bridge_7.clientX > 0) {
                    state.interaction.bridge_7.clientX -= (1/32);
                };
            };
        };
         // left
        if ( state.interaction.bridge_7.clientX <= 0 && state.interaction.bridge_7.cycles.walking == true ) {
            state.interaction.bridge_7.clientX = 0;
            //state.interaction.bridge_7.cycles.walking = false;
             // reset face
            state.interaction.bridge_7.stance = 1;
             // auto walk
            state.interaction.bridge_7.clientX += (1/32);
        };
         // right
        if ( state.interaction.bridge_7.clientX >= 7 && state.interaction.bridge_7.cycles.walking == true ) {
            state.interaction.bridge_7.clientX = 7;
            //state.interaction.bridge_7.cycles.walking = false;
             // reset face
            state.interaction.bridge_7.stance = 0;
             // auto walk
            state.interaction.bridge_7.clientX -= (1/32);
        };
         // automated moving
        let facer_1 = document.getElementById('facer_1');
        facer_1.style =
            'height: ' + (state.interaction.bridge_7.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_7.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_7.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_7.clientX * (tiny_width / 8)) + 'px;';
        */
      }
      ...
      if (document.getElementById('facer_2') != null) {
        if (state.interaction.bridge_8.stance == 0) {
          if (state.interaction.bridge_8.angle == 0) {
            document.getElementById('facer_2').classList = ' width_50 height_50 top_0 left_0 right_0 bottom_0 gui_logo_type_' + state.interaction.bridge_8.frame + ' position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_8.angle == 1) {
            document.getElementById('facer_2').classList = ' width_50 height_50 top_0 left_0 right_0 bottom_0 gui_logo_type_' + state.interaction.bridge_8.frame + ' position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_8.frame == 4) {
          state.interaction.bridge_8.frame = 0;
        }

        ;
        state.interaction.bridge_8.frame += 1;
        /*
        // automated motion
        if ( state.interaction.bridge_8.cycles.walking == true) {
             // stance: up
            if ( state.interaction.bridge_8.stance == 3 ) {
                 
                // player walking and pause
                if (state.interaction.bridge_8.clientY < 3) {
                    state.interaction.bridge_8.clientY += (1/32);
                };
            };
             // stance: down
            if ( state.interaction.bridge_8.stance == 2 ) {
                 // player walking and pause
                if (state.interaction.bridge_8.clientY > -4) {
                    state.interaction.bridge_8.clientY -= (1/32);
                };
            };
             // stance: right
            if ( state.interaction.bridge_8.stance == 1 ) {
                // player walking and pause
                if (state.interaction.bridge_8.clientX < 8) {
                    state.interaction.bridge_8.clientX += (1/32);
                };
            };
             // stance: left
            if ( state.interaction.bridge_8.stance == 0 ) {
                 // player walking and pause
                if (state.interaction.bridge_8.clientX > 0) {
                    state.interaction.bridge_8.clientX -= (1/32);
                };
            };
        };
         // left
        if ( state.interaction.bridge_8.clientX <= 0 && state.interaction.bridge_8.cycles.walking == true ) {
            state.interaction.bridge_8.clientX = 0;
            //state.interaction.bridge_8.cycles.walking = false;
             // reset face
            state.interaction.bridge_8.stance = 1;
             // auto walk
            state.interaction.bridge_8.clientX += (1/32);
        };
         // right
        if ( state.interaction.bridge_8.clientX >= 7 && state.interaction.bridge_8.cycles.walking == true ) {
            state.interaction.bridge_8.clientX = 7;
            //state.interaction.bridge_8.cycles.walking = false;
             // reset face
            state.interaction.bridge_8.stance = 0;
             // auto walk
            state.interaction.bridge_8.clientX -= (1/32);
        };
         // automated moving
        let facer_2 = document.getElementById('facer_2');
        facer_2.style =
            'height: ' + (state.interaction.bridge_8.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_8.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_8.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_8.clientX * (tiny_width / 8)) + 'px;';
         */
      }

      ;

      if (document.getElementById('facer_1_final') != null) {
        if (state.interaction.bridge_7.stance == 0) {
          if (state.interaction.bridge_7.angle == 0) {
            document.getElementById('facer_1_final').classList = ' width_50 height_50 top_0 left_0 right_0 bottom_0 gui_character_face_left_shadow_' + state.interaction.bridge_7.frame + ' position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_7.clientX >= 7 && state.interaction.bridge_7.cycles.walking == true ) {
         ...
         // automated moving
        let facer_1_final = document.getElementById('facer_1_final');
        facer_1_final.style =
            'height: ' + (state.interaction.bridge_7.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_7.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_7.clientY * (tiny_height / 8)) + 'px;' +
      ...
      if (document.getElementById('facer_2_final') != null) {
        if (state.interaction.bridge_8.stance == 0) {
          if (state.interaction.bridge_8.angle == 0) {
            document.getElementById('facer_2_final').classList = ' width_50 height_50 top_0 left_0 right_0 bottom_0 gui_logo_type_' + state.interaction.bridge_8.frame + ' position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_8.clientX >= 7 && state.interaction.bridge_8.cycles.walking == true ) {
         ...
         // automated moving
        let facer_2_final = document.getElementById('facer_2_final');
        facer_2_final.style =
            'height: ' + (state.interaction.bridge_8.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_8.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_8.clientY * (tiny_height / 8)) + 'px;' +
      ...
      if (document.getElementById('facer_buttons_final') != null) {
        if (state.interaction.bridge_6.stance == 0) {
          if (state.interaction.bridge_6.angle == 0) {
            document.getElementById('facer_buttons_final').classList = ' width_50 height_25 bottom_0 left_0 right_0 gui_buttons position_absolute margin_auto ';
          }
        ...
        if ( state.interaction.bridge_6.clientX >= 7 && state.interaction.bridge_6.cycles.walking == true ) {
         ...
         // automated moving
        let facer_buttons_final = document.getElementById('facer_buttons_final');
        facer_buttons_final.style =
            'height: ' + (state.interaction.bridge_6.height * (tiny_height / 8)) + 'px;' +
            'width: ' + (state.interaction.bridge_6.width * (tiny_width / 8)) + 'px;' +
            'bottom: ' + (state.interaction.bridge_6.clientY * (tiny_height / 8)) + 'px;' +
            'left: ' + (state.interaction.bridge_6.clientX * (tiny_width / 8)) + 'px;';
      ...
      if (document.getElementById('logo') != null) {
        if (state.interaction.bridge_9.stance == 0) {
          if (state.interaction.bridge_9.angle == 0) {
            document.getElementById('logo').classList = ' width_100 height_100 gui_logo_type_' + state.interaction.bridge_9.frame + ' position_absolute margin_auto ';
          }

          ;

          if (state.interaction.bridge_9.angle == 1) {
            document.getElementById('logo').classList = ' width_100 height_100 gui_logo_type_' + state.interaction.bridge_9.frame + ' position_absolute margin_auto ';
          }
        ...
        if (state.interaction.bridge_9.frame == 4) {
          state.interaction.bridge_9.frame = 0;
        }

        ;
        state.interaction.bridge_9.frame += 1; // automated motion

        if (state.interaction.bridge_9.cycles.walking == true) {
          // stance: up
          if (state.interaction.bridge_9.stance == 3) {
            // player walking and pause
            if (state.interaction.bridge_9.clientY < 3) {
              state.interaction.bridge_9.clientY += 1 / 32;
            }
          ...
          if (state.interaction.bridge_9.stance == 2) {
            // player walking and pause
            if (state.interaction.bridge_9.clientY > -4) {
              state.interaction.bridge_9.clientY -= 1 / 32;
            }
          ...
          if (state.interaction.bridge_9.stance == 1) {
            // player walking and pause
            if (state.interaction.bridge_9.clientX < 8) {
              state.interaction.bridge_9.clientX += 1 / 32;
            }
          ...
          if (state.interaction.bridge_9.stance == 0) {
            // player walking and pause
            if (state.interaction.bridge_9.clientX > 0) {
              state.interaction.bridge_9.clientX -= 1 / 32;
            }
        ...
        if (state.interaction.bridge_9.clientX <= 0 && state.interaction.bridge_9.cycles.walking == true) {
          state.interaction.bridge_9.clientX = 0; //state.interaction.bridge_9.cycles.walking = false;
          // reset face

          state.interaction.bridge_9.stance = 1; // auto walk
        ...
        if (state.interaction.bridge_9.clientX >= 7 && state.interaction.bridge_9.cycles.walking == true) {
          state.interaction.bridge_9.clientX = 7; //state.interaction.bridge_9.cycles.walking = false;
          // reset face

          state.interaction.bridge_9.stance = 0; // auto walk
        ...
        logo.style = 'height: ' + state.interaction.bridge_9.height * (tiny_height / 8) + 'px;' + 'width: ' + state.interaction.bridge_9.width * (tiny_width / 8) + 'px;' + 'bottom: ' + state.interaction.bridge_9.clientY * (tiny_height / 8) + 'px;' + 'left: ' + state.interaction.bridge_9.clientX * (tiny_width / 8) + 'px;';
      }
...
var handle_INITIAL_LOOP = function handle_INITIAL_LOOP() {
  ...
  if (localStorage.user == null) {
    alert('welcome first timer, handle_INITIAL_LOOP'); // 24/fps loop !! initial !!
  ...
  if (localStorage.user == 'new') {
    alert('welcome returning user, handle_INITIAL_LOOP'); // 24/fps loop !! initial !!
    ...
    (function () {
      ...
      var play = setInterval(function () {
        ...
        if (interval == 24 * 7) {
          if (document.getElementById('shots') != null) {
            alert('face idle, logo idle, buttons 1, 2 & 3');
            shot_to_scene_1();
          }
