...
let shot_start_of_authing_facer_button = () => {
...
let shot_end_of_authing_facer_button = () => {
...
let handle_if_AUTH_checked_CLICK_SCENE_shot_to_scene_facer_button = () => {
    alert('handle_if_AUTH_checked_CLICK_SCENE_shot_to_scene_facer_button');
    // 24/fps loop
    (() => {
        let interval = 0;
        let play = setInterval(
        ...
        setInterval(
            () => {
                ...
                if (document.getElementById('gui_stage_tv') != null) {
                    ...
                    state.interaction.bridge_1.frame += 1;
                    ...
                    if ( state.interaction.bridge_1.clientX <= 0 && state.interaction.bridge_1.cycles.walking == true ) {
                        state.interaction.bridge_1.clientX = 0;
                        //state.interaction.bridge_1.cycles.walking = false;

                        // reset face
                        state.interaction.bridge_1.stance = 1;
                    ...
                    if ( state.interaction.bridge_1.clientX >= 7 && state.interaction.bridge_1.cycles.walking == true ) {
                        state.interaction.bridge_1.clientX = 7;
                        //state.interaction.bridge_1.cycles.walking = false;

                        // reset face
                        state.interaction.bridge_1.stance = 0;
                    ...
                    gui_stage_tv.style =
                        'height: ' + (state.interaction.bridge_1.height * (tiny_height / 8)) + 'px;' +
                        'width: ' + (state.interaction.bridge_1.width * (tiny_width / 8)) + 'px;' +
                        'bottom: ' + (state.interaction.bridge_1.clientY * (tiny_height / 8)) + 'px;' +
                        'left: ' + (state.interaction.bridge_1.clientX * (tiny_width / 8)) + 'px;';
                };
                ...
                if (document.getElementById('gui_stage_lights') != null) {
                    ...
                    state.interaction.bridge_2.frame += 1;
                    ...
                    if ( state.interaction.bridge_2.clientX <= 0 && state.interaction.bridge_2.cycles.walking == true ) {
                        state.interaction.bridge_2.clientX = 0;
                        //state.interaction.bridge_2.cycles.walking = false;

                        // reset face
                        state.interaction.bridge_2.stance = 1;
                    ...
                    if ( state.interaction.bridge_2.clientX >= 7 && state.interaction.bridge_2.cycles.walking == true ) {
                        state.interaction.bridge_2.clientX = 7;
                        //state.interaction.bridge_2.cycles.walking = false;

                        // reset face
                        state.interaction.bridge_2.stance = 0;
                    ...
                    gui_stage_lights.style =
                        'height: ' + (state.interaction.bridge_2.height * (tiny_height / 8)) + 'px;' +
                        'width: ' + (state.interaction.bridge_2.width * (tiny_width / 8)) + 'px;' +
                        'bottom: ' + (state.interaction.bridge_2.clientY * (tiny_height / 8)) + 'px;' +
                        'left: ' + (state.interaction.bridge_2.clientX * (tiny_width / 8)) + 'px;';
                };
                ...
                if (document.getElementById('mark') != null) {
                    ...
                    state.interaction.bridge_3.frame += 1;
                    ...
                    if ( state.interaction.bridge_3.clientX <= 0 && state.interaction.bridge_3.cycles.walking == true ) {
                        state.interaction.bridge_3.clientX = 0;
                        //state.interaction.bridge_3.cycles.walking = false;

                        // reset face
                        state.interaction.bridge_3.stance = 1;
                    ...
                    if ( state.interaction.bridge_3.clientX >= 7 && state.interaction.bridge_3.cycles.walking == true ) {
                        state.interaction.bridge_3.clientX = 7;
                        //state.interaction.bridge_3.cycles.walking = false;

                        // reset face
                        state.interaction.bridge_3.stance = 0;
                    ...
                    mark.style =
                        'height: ' + (state.interaction.bridge_3.height * (tiny_height / 8)) + 'px;' +
                        'width: ' + (state.interaction.bridge_3.width * (tiny_width / 8)) + 'px;' +
                        'bottom: ' + (state.interaction.bridge_3.clientY * (tiny_height / 8)) + 'px;' +
                        'left: ' + (state.interaction.bridge_3.clientX * (tiny_width / 8)) + 'px;';
                };
                ...
                if (document.getElementById('logo') != null) {
                    ...
                    state.interaction.bridge_9.frame += 1;
                    ...
                    if ( state.interaction.bridge_9.clientX <= 0 && state.interaction.bridge_9.cycles.walking == true ) {
                        state.interaction.bridge_9.clientX = 0;
                        //state.interaction.bridge_9.cycles.walking = false;

                        // reset face
                        state.interaction.bridge_9.stance = 1;
                    ...
                    if ( state.interaction.bridge_9.clientX >= 7 && state.interaction.bridge_9.cycles.walking == true ) {
                        state.interaction.bridge_9.clientX = 7;
                        //state.interaction.bridge_9.cycles.walking = false;

                        // reset face
                        state.interaction.bridge_9.stance = 0;
                    ...
                    logo.style =
                        'height: ' + (state.interaction.bridge_9.height * (tiny_height / 8)) + 'px;' +
                        'width: ' + (state.interaction.bridge_9.width * (tiny_width / 8)) + 'px;' +
                        'bottom: ' + (state.interaction.bridge_9.clientY * (tiny_height / 8)) + 'px;' +
                        'left: ' + (state.interaction.bridge_9.clientX * (tiny_width / 8)) + 'px;';
                };
