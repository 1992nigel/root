...
let Handle_EventListeners = () => {
        ...
        if ((document.getElementById('icon_contact')) != null ) {
            document.getElementById('icon_contact').addEventListener("click", function(event) {
...
let HANDLE_animation_logo_menu = () => {
    //alert('yup');

     (function() {
        let HANDLE_animation_logo_menu_current_frame = 0;
        let HANDLE_animation_logo_menu_starter =
        setInterval(
            function() {
                let MANIPULATED = document.getElementById('icon_logo');
                
                    if (MANIPULATED != null) {
                        MANIPULATED.innerHTML = '';

                        if (HANDLE_animation_logo_menu_current_frame == 0) {
                            MANIPULATED.classList.remove('dj_gui_logo_1');
                                MANIPULATED.classList.remove('dj_gui_logo_2');
                                MANIPULATED.classList.remove('dj_gui_logo_3');
                                MANIPULATED.classList.remove('dj_gui_logo_4');
                                MANIPULATED.classList.add('dj_gui_logo_4');
                                MANIPULATED.classList.remove('pulse');
                        };

                        if (HANDLE_animation_logo_menu_current_frame == 1) {
                            MANIPULATED.classList.remove('dj_gui_logo_1');
                                MANIPULATED.classList.remove('dj_gui_logo_2');
                                MANIPULATED.classList.remove('dj_gui_logo_3');
                                MANIPULATED.classList.remove('dj_gui_logo_4');
                                MANIPULATED.classList.add('dj_gui_logo_3');
                        };

                        if (HANDLE_animation_logo_menu_current_frame == 2) {
                            MANIPULATED.classList.remove('dj_gui_logo_1');
                                MANIPULATED.classList.remove('dj_gui_logo_2');
                                MANIPULATED.classList.remove('dj_gui_logo_3');
                                MANIPULATED.classList.remove('dj_gui_logo_4');
                                MANIPULATED.classList.add('dj_gui_logo_2');
                        };

                        if (HANDLE_animation_logo_menu_current_frame == 3) {
                            MANIPULATED.classList.remove('dj_gui_logo_1');
                                MANIPULATED.classList.remove('dj_gui_logo_2');
                                MANIPULATED.classList.remove('dj_gui_logo_3');
                                MANIPULATED.classList.remove('dj_gui_logo_4');
                                MANIPULATED.classList.add('dj_gui_logo_1');

                            HANDLE_animation_logo_menu_current_frame = 0;
                        };

                        HANDLE_animation_logo_menu_current_frame += 1;
                    }
...
let HANDLE_animation_loading_machine = () => {
    //alert('yup');

     (function() {
        let HANDLE_animation_loading_machine_current_frame = 0;
        let HANDLE_animation_loading_machine_starter =
        setInterval(
            function() {
                let MANIPULATED = document.getElementById('loading_machines');
                
                    if (MANIPULATED != null) {
                        MANIPULATED.innerHTML = '';

                        if (HANDLE_animation_loading_machine_current_frame == 0) {
                            MANIPULATED.classList.remove('gui_loading_machine_1');
                                MANIPULATED.classList.remove('gui_loading_machine_2');
                                MANIPULATED.classList.remove('gui_loading_machine_3');
                                MANIPULATED.classList.remove('gui_loading_machine_4');
                                MANIPULATED.classList.add('gui_loading_machine_4');
                        };

                        if (HANDLE_animation_loading_machine_current_frame == 1) {
                            MANIPULATED.classList.remove('gui_loading_machine_1');
                                MANIPULATED.classList.remove('gui_loading_machine_2');
                                MANIPULATED.classList.remove('gui_loading_machine_3');
                                MANIPULATED.classList.remove('gui_loading_machine_4');
                                MANIPULATED.classList.add('gui_loading_machine_3');
                        };

                        if (HANDLE_animation_loading_machine_current_frame == 2) {
                            MANIPULATED.classList.remove('gui_loading_machine_1');
                                MANIPULATED.classList.remove('gui_loading_machine_2');
                                MANIPULATED.classList.remove('gui_loading_machine_3');
                                MANIPULATED.classList.remove('gui_loading_machine_4');
                                MANIPULATED.classList.add('gui_loading_machine_2');
                        };

                        if (HANDLE_animation_loading_machine_current_frame == 3) {
                            MANIPULATED.classList.remove('gui_loading_machine_1');
                                MANIPULATED.classList.remove('gui_loading_machine_2');
                                MANIPULATED.classList.remove('gui_loading_machine_3');
                                MANIPULATED.classList.remove('gui_loading_machine_4');
                                MANIPULATED.classList.add('gui_loading_machine_1');

                            HANDLE_animation_loading_machine_current_frame = 0;
                        };

                        HANDLE_animation_loading_machine_current_frame += 1;
                    }
...
let HANDLE_animation_logo_loading = () => {
    //alert('yup');

     (function() {
        let HANDLE_animation_logo_loading_current_frame = 0;
        let HANDLE_animation_logo_loading_starter =
        setInterval(
            function() {
                let MANIPULATED = document.getElementById('loading_letters');
                
                    if (MANIPULATED != null) {
                        MANIPULATED.innerHTML = '';

                        if (HANDLE_animation_logo_loading_current_frame == 0) {
                                MANIPULATED.classList.remove('gui_loading_1');
                                MANIPULATED.classList.remove('gui_loading_2');
                                MANIPULATED.classList.remove('gui_loading_3');
                                MANIPULATED.classList.remove('gui_loading_4');
                                MANIPULATED.classList.remove('gui_loading_5');
                                MANIPULATED.classList.remove('gui_loading_6');
                                MANIPULATED.classList.remove('gui_loading_7');
                                MANIPULATED.classList.add('gui_loading_1');
                        };

                        if (HANDLE_animation_logo_loading_current_frame == 1) {
                                MANIPULATED.classList.remove('gui_loading_1');
                                MANIPULATED.classList.remove('gui_loading_2');
                                MANIPULATED.classList.remove('gui_loading_3');
                                MANIPULATED.classList.remove('gui_loading_4');
                                ...
                                MANIPULATED.classList.remove('gui_loading_6');
                                MANIPULATED.classList.remove('gui_loading_7');
                                MANIPULATED.classList.add('gui_loading_2');
                        };

                        if (HANDLE_animation_logo_loading_current_frame == 2) {
                                MANIPULATED.classList.remove('gui_loading_1');
                                MANIPULATED.classList.remove('gui_loading_2');
                                MANIPULATED.classList.remove('gui_loading_3');
                                MANIPULATED.classList.remove('gui_loading_4');
                                ...
                                MANIPULATED.classList.remove('gui_loading_6');
                                MANIPULATED.classList.remove('gui_loading_7');
                                MANIPULATED.classList.add('gui_loading_3');
                        };

                        if (HANDLE_animation_logo_loading_current_frame == 3) {
                                MANIPULATED.classList.remove('gui_loading_1');
                                MANIPULATED.classList.remove('gui_loading_2');
                                MANIPULATED.classList.remove('gui_loading_3');
                                MANIPULATED.classList.remove('gui_loading_4');
                                ...
                                MANIPULATED.classList.remove('gui_loading_6');
                                MANIPULATED.classList.remove('gui_loading_7');
                                MANIPULATED.classList.add('gui_loading_4');
                        };

                        if (HANDLE_animation_logo_loading_current_frame == 4) {
                                MANIPULATED.classList.remove('gui_loading_1');
                                MANIPULATED.classList.remove('gui_loading_2');
                                MANIPULATED.classList.remove('gui_loading_3');
                                MANIPULATED.classList.remove('gui_loading_4');
                                ...
                                MANIPULATED.classList.remove('gui_loading_6');
                                MANIPULATED.classList.remove('gui_loading_7');
                                MANIPULATED.classList.add('gui_loading_5');
                        };

                        if (HANDLE_animation_logo_loading_current_frame == 5) {
                                MANIPULATED.classList.remove('gui_loading_1');
                                MANIPULATED.classList.remove('gui_loading_2');
                                MANIPULATED.classList.remove('gui_loading_3');
                                MANIPULATED.classList.remove('gui_loading_4');
                                ...
                                MANIPULATED.classList.remove('gui_loading_6');
                                MANIPULATED.classList.remove('gui_loading_7');
                                MANIPULATED.classList.add('gui_loading_6');
                        };

                        if (HANDLE_animation_logo_loading_current_frame == 6) {
                                MANIPULATED.classList.remove('gui_loading_1');
                                MANIPULATED.classList.remove('gui_loading_2');
                                MANIPULATED.classList.remove('gui_loading_3');
                                MANIPULATED.classList.remove('gui_loading_4');
                                ...
                                MANIPULATED.classList.remove('gui_loading_6');
                                MANIPULATED.classList.remove('gui_loading_7');
                                MANIPULATED.classList.add('gui_loading_7');

                            //clearInterval(HANDLE_animation_logo_loading_starter);
                            HANDLE_animation_logo_loading_current_frame = 0;
                        };

                        HANDLE_animation_logo_loading_current_frame += 1;
                    }
...
let HANDLE_animations = () => {
    ...
    if (state.animation.scene == 2) {
        console.log('1');
        // begin color fill animation on animation_fourground_hands_1
        HANDLE_animation_loading();
        HANDLE_animation_logo_menu();
        HANDLE_animation_loading_machine();
        HANDLE_animation_logo_loading();
    };
    // two
    if (state.animation.scene == 3) {
        console.log('2');
        // bring "face" into frame
        HANDLE_animation_begin();
    };
    // three
    if (state.animation.scene == 4) {
        console.log('3');
        // frames for character to slap on logo
