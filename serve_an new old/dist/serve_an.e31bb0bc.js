...
var shot_game_start = function shot_game_start() {
...
var shot_game_end = function shot_game_end() {
  if (document.getElementById('set') != null) {
    var set = document.getElementById('set');
    set.innerHTML = "\n        ";
  }
...
var shot_action_single_wall = function shot_action_single_wall() {
...
var shot_action_single_enter = function shot_action_single_enter() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_single_idle = function shot_action_single_idle() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_single_leave = function shot_action_single_leave() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_single_blank = function shot_action_single_blank() {
  if (document.getElementById('shots') != null) {
...
var shot_action_single_blink = function shot_action_single_blink() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_action_single_loaded_leave = function shot_action_single_loaded_leave() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
  ...
  document.getElementById('shots').appendChild(element); // shot_action_single_loaded_leave loop
...
var act_4_shot_enter = function act_4_shot_enter() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var act_4_shot_mid = function act_4_shot_mid() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var act_4_shot_ending = function act_4_shot_ending() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var act_4_shot_buttons = function act_4_shot_buttons() {
  if (document.getElementById('shot_1') != null) {
    var shot_1 = document.getElementById('shot_1');
...
var shot_home = function shot_home() {
  var shots = document.getElementById('shots');
  shots.innerHTML = "";
  var element = document.createElement('div');
  element.setAttribute("id", "shot_1");
  ...
  (function () {
    ...
    var play = setInterval(function () {
      ...
      if (interval == 24 * 4) {
        if (document.getElementById('shots') != null) {
          //alert('shot_action_single_loaded_leave');
          shot_action_single_blink(); //shot_home();
        }
      ...
      if (interval == 24 * 6) {
        if (document.getElementById('shots') != null) {
          //alert('shot_action_single_loaded_leave');
          shot_action_single_vomit(); //shot_home();
        }
      ...
      if (interval == 24 * 12) {
        if (document.getElementById('shots') != null) {
          //alert('shot_action_single_loaded_leave');
          shot_action_single_wall(); //shot_home();
        }
      ...
      if (interval == 24 * 14) {
        if (document.getElementById('shots') != null) {
          //alert('shot_action_single_loaded_leave');
          shot_action_single_enter(); //shot_home();
        }
      ...
      if (interval == 24 * 16) {
        if (document.getElementById('shots') != null) {
          //alert('shot_action_single_loaded_leave');
          shot_action_single_idle(); //shot_home();
        }
      ...
      if (interval == 24 * 18) {
        if (document.getElementById('shots') != null) {
          //alert('shot_action_single_loaded_leave');
          shot_action_single_leave(); //shot_home();
        }
      ...
      if (interval == 24 * 20) {
        if (document.getElementById('shots') != null) {
          //alert('shot_action_single_loaded_leave');
          shot_action_single_blank(); //shot_home();
        }
