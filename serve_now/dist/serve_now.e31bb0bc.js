...
var posts_guides = []; // Your web app's Firebase configuration
...
var handle_if_AUTH_checked_SCENE_1 = function handle_if_AUTH_checked_SCENE_1() {
  // 24/fps loop
  (function () {
    var interval = 0;
...
var handle_if_AUTH_checked_ANIMATION = function handle_if_AUTH_checked_ANIMATION() {
  // 24/fps loop
  (function () {
    var interval = 0;
    setInterval(function () {
...
var handle_if_AUTH = function handle_if_AUTH() {
  handle_if_AUTH_checked_ANIMATION(); // 24/fps loop !! initial !!
...
var handle_firebase_events = function handle_firebase_events() {
  ...
  fileButton.addEventListener('change', function (event) {
    ...
    task.on('state_changed', function progress(snapshot) {
      ...
      var upload_details = ""; // Handle successful uploads on complete
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "52755" + '/');
