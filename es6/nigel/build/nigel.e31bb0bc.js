...
var Handle_folds = function Handle_folds() {
  ...
  if (document.getElementById('folds') != null) {
    if (state.animation.instances.sequence == 0) {
      state.animation.instances.fold = 0;
      console.log('sequence next 1');
      document.getElementById('folds').innerHTML = "";
    ...
    if (state.animation.instances.sequence == 1) {
      state.animation.instances.fold = 1;
      document.getElementById('root_loading').classList.add('display_none');
      console.log('sequence next 1');
      document.getElementById('folds').innerHTML = "\n\n                    <div id=\"folds_loading\" class=\"width_100 height_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto\">\n\n                        <div class=\"calc_25vh max_width width_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto\">\n\n                            <div id=\"folds_loading_motion\" class=\"width_25 height_25 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\">\n\n                                <div id=\"folds_loading_center_container\" class=\"width_100 height_100 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\">\n                                    \n                                    <div id=\"folds_loading_svg\" class=\"gui_made_by width_100 height_100 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\"></div>\n                                \n                                </div>\n\n                            </div>\n\n                        </div>\n\n                    </div>\n\n                "; // stops the redraw
    ...
    if (state.animation.instances.sequence == 2) {
      state.animation.instances.fold = 2;
      console.log('sequence next 2');
      document.getElementById('folds').innerHTML = "\n\n                    <div id=\"folds_loading\" class=\"width_100 height_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto\">\n\n                        <div class=\"calc_25vh max_width width_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto\">\n\n                            <div id=\"folds_loading_motion\" class=\"width_25 height_25 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\">\n\n                                <div id=\"folds_loading_center_container\" class=\"width_100 height_100 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\">\n                                    \n                                    <div id=\"folds_loading_svg\" class=\"gui_original width_100 height_100 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\"></div>\n                                \n                                </div>\n\n                            </div>\n\n                        </div>\n\n                    </div>\n\n                "; // stops the redraw
    ...
    if (state.animation.instances.sequence == 3) {
      state.animation.instances.fold = 3;
      console.log('sequence next 3');
      document.getElementById('folds').innerHTML = "\n\n                    <div id=\"folds_loading\" class=\"width_100 height_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto\">\n\n                        <div class=\"calc_25vh max_width width_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto\">\n\n                            <div id=\"folds_loading_motion\" class=\"width_25 height_25 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\">\n\n                                <div id=\"folds_loading_center_container\" class=\"width_100 height_100 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\">\n                                    \n                                    <div id=\"folds_loading_svg\" class=\"gui_based width_100 height_100 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\"></div>\n                                \n                                </div>\n\n                            </div>\n\n                        </div>\n\n                    </div>\n\n                "; // stops the redraw
    ...
    if (state.animation.instances.sequence == 4) {
      state.animation.instances.fold = 4;
      console.log('sequence next 4');
      document.getElementById('folds').innerHTML = "\n\n                    <div id=\"folds_loading\" class=\"width_100 height_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto\">\n\n                        <div class=\"calc_25vh max_width width_100 top_0 bottom_0 left_0 right_0 position_absolute margin_auto\">\n\n                            <div id=\"folds_loading_motion\" class=\"width_25 height_25 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\">\n\n                                <div id=\"folds_loading_center_container\" class=\"width_100 height_100 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\">\n                                    \n                                    <div id=\"folds_loading_svg\" class=\"gui_handcrafted width_100 height_100 position_absolute top_0 bottom_0 left_0 right_0 margin_auto\"></div>\n                                \n                                </div>\n\n                            </div>\n\n                        </div>\n\n                    </div>\n\n                "; // stops the redraw
    ...
    if (state.animation.instances.sequence == 5) {
      state.animation.instances.fold = 5;
    ...
    if (state.animation.instances.sequence == 6) {
      state.animation.instances.fold = 6;
      document.getElementById('folds').innerHTML = ""; // stops the redraw
    ...
    if (state.animation.instances.sequence == 7) {
      state.animation.instances.fold = 7;
      document.getElementById('folds').innerHTML = ""; // stops the redraw
    ...
    if (state.animation.instances.sequence == 8) {
      state.animation.instances.fold = 8;
      document.getElementById('folds').innerHTML = ""; // stops the redraw
    ...
    if (state.animation.instances.sequence == 9) {
      state.animation.instances.fold = 9;
      document.getElementById('folds').innerHTML = ""; // stops the redraw
    ...
    if (state.animation.instances.sequence == 10) {
      state.animation.instances.fold = 10;
      document.getElementById('folds').innerHTML = "\n\n                "; // stops the redraw
    ...
    if (state.animation.instances.sequence == 11) {
      state.animation.instances.fold = 11;
      document.getElementById('folds').innerHTML = "\n\n                "; // stops the redraw
    ...
    if (state.animation.instances.sequence == 12) {
      state.animation.instances.fold = 12;
    ...
    if (state.animation.instances.sequence == 13) {
      state.animation.instances.fold = 13;
    ...
    if (state.animation.instances.sequence == 14) {
      state.animation.instances.fold = 14;
    ...
    if (state.animation.instances.sequence == 15) {
      state.animation.instances.fold = 15;
    ...
    if (state.animation.instances.sequence == 16) {
      state.animation.instances.fold = 16;
    ...
    if (state.animation.instances.sequence == 17) {
      state.animation.instances.fold = 17;
    ...
    if (state.animation.instances.sequence == 18) {
      state.animation.instances.fold = 18;
    ...
    if (state.animation.instances.sequence == 19) {
      state.animation.instances.fold = 19;
    ...
    if (state.animation.instances.sequence == 20) {
      state.animation.instances.fold = 20;
      alert('fold: 20');
      ...
      setTimeout(function () {
        if (first_load == true) {
          ...
          setTimeout(function () {
            ...
            Handle_loaded_firebase_data(); // re_check
...
var Handle_Rerender_Firebase = function Handle_Rerender_Firebase() {
  rootRef = firebase.database().ref();
  gnougnRef = rootRef.child('gnougn');
  wordpressRef = gnougnRef.child('wordpress');
...
var Handle_loaded_firebase_data = function Handle_loaded_firebase_data() {
  Handle_render_view();
  check_local_user();
  Handle_Timers(); // overall site frames by 24 frames
...
var Handle_load_sequences = function Handle_load_sequences() {
...
var _default = {
  ...
  Handle_loaded_firebase_data: Handle_loaded_firebase_data,
...
//# sourceMappingURL=/nigel.e31bb0bc.map