...
exports.default = {
  ...
  route_dashboard_not_logged: route_dashboard_not_logged,
...
},{"../index.js":3}],372:[function(require,module,exports) {
'use strict';
...
},{"../index.js":3,"./elements":376}],373:[function(require,module,exports) {
'use strict';
...
},{"../index.js":3}],379:[function(require,module,exports) {
'use strict';
...
},{"./elements":376}],375:[function(require,module,exports) {
'use strict';
...
var get_components_handled = function get_components_handled() {
    ...
    // dev mode
    {
        ...
        component_state_display: state.animation.instances.loaded && state.animation.instances.loaded_1
        // component_state_opacity:  state.animation.instances.loading
    }, {
        component: 'cursor_move_ctas',
        //component_state_transform: state.animation.instances.loading,
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded && state.animation.instances.loaded_1
        ...
        component: 'key_press_ctas',
        //component_state_transform: state.animation.instances.loading,
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded_2
        // component_state_opacity:  state.animation.instances.loading
    }, {
        component: 'scroll_up_ctas',
        //component_state_transform: state.animation.instances.loading,
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded_3
        // component_state_opacity:  state.animation.instances.loading
    }, {
        component: 'scroll_down_ctas',
        //component_state_transform: state.animation.instances.loading,
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded_4
        // component_state_opacity:  state.animation.instances.loading
    }, {
        component: 'game',
        //component_state_transform: state.animation.instances.loading,
        ...
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.scrolling
        // component_state_opacity:  state.animation.instances.loading
    },
...
},{"../index.js":3}],377:[function(require,module,exports) {
'use strict';
...
},{"../index.js":3}],378:[function(require,module,exports) {
'use strict';
...
var walking_up_frame = 0;
var walking_down_frame = 0;
...
var Handle_ui = function Handle_ui() {
    ...
    if (document.getElementById('bridge') != null) {
        document.getElementById('bridge').style = 'height: ' + state.ui.interaction.bridge.height * state.ux.dimensions.height8 + 'px;' + 'width: ' + state.ui.interaction.bridge.width * state.ux.dimensions.width8 + 'px;' + 'bottom: ' + state.ui.interaction.bridge.yaxis * state.ux.dimensions.height8 + 'px;' + 'left: ' + state.ui.interaction.bridge.xaxis * state.ux.dimensions.width8 + 'px;';
    };
    ...
    if (state.ui.interaction.player_2.stance == 9) {
        ...
        // standing up loop
        if (state.ui.interaction.player_2.idle.standing && !state.ui.interaction.player_2.cycles.walking) {
    ...
    // player: 2
    if (document.getElementById('player_2_svg') != null) {
        document.getElementById('player_2_svg').style = 'height: ' + state.ui.interaction.player_2.height * state.ux.dimensions.height8 + 'px;' + 'width: ' + state.ui.interaction.player_2.width * state.ux.dimensions.width8 + 'px;' + 'bottom: ' + state.ui.interaction.player_2.yaxis * state.ux.dimensions.height8 + 'px;' + 'left: ' + state.ui.interaction.player_2.xaxis * state.ux.dimensions.width8 + 'px;';
    };
...
var addListings = function addListings(child) {
    ...
    if (state.data.user.username != null) {
        if (child == 'library') {
            ...
            }, _defineProperty(_default_item, 'feature_image_src', document.getElementById('element_input_feature_image_src').value), _defineProperty(_default_item, 'username', state.data.user.username), _defineProperty(_default_item, 'views', 0), _defineProperty(_default_item, 'likes', 0), _defineProperty(_default_item, 'dislikes', 0), _default_item);
        };
    };
...
var sign_in_ui = function sign_in_ui() {
    ...
    // set author page
    document.getElementById('component_app_modal_element_page_right_content').innerHTML = _elements2.default.route_dashboard(state.data.user);
...
var sign_out_ui = function sign_out_ui() {
    ...
    // set author page
    document.getElementById('component_app_modal_element_page_right_content').innerHTML = _elements2.default.route_dashboard_not_logged();
...
var Handle_firebase_render = function Handle_firebase_render() {
    ...
    (function () {
        ...
        setTimeout(function () {
            ...
            if (document.getElementById('element_input_filter') != null && document.getElementById('element_input_post_username') != null && document.getElementById('element_input_post_types') != null) {
                ...
                if (document.getElementById('element_ol_firebase_user_library') != null) {
                    ...
                    for (var i = 0; i < filtered_array_gnougn_library.length; i++) {
                        ...
                        if (filtered_array_gnougn_library[i].username == state.data.user.username) {
                            document.getElementById('element_ol_firebase_user_library').appendChild(_functions2.default.Generate_new_fragment.appendChild(_functions2.default.Generate_new_li(filtered_array_gnougn_library[i])));
                        };
                    }
                };
                ...
                if (document.getElementById('element_ol_firebase_user_subs_library') != null) {
                    ...
                    for (var i = 0; i < filtered_array_gnougn_library.length; i++) {
                        ...
                        for (var subs_index = 0; subs_index < state.data.user.subs.length; subs_index++) {
                            ...
                            // subs name
                            document.getElementById('element_ol_firebase_user_subs_library').appendChild(_functions2.default.Generate_new_fragment.appendChild(_functions2.default.Generate_new_div('<h1><u>' + state.data.user.subs[subs_index].username + '</u>\'s post</h1>')));

                            // subs posts
                            if (filtered_array_gnougn_library[i].username == state.data.user.subs[subs_index].username) {

                                document.getElementById('element_ol_firebase_user_subs_library').appendChild(_functions2.default.Generate_new_fragment.appendChild(_functions2.default.Generate_new_li(filtered_array_gnougn_library[i])));
                            };
                        };
                    }
                };
                ...
                if (document.getElementById('element_ol_firebase_post_username_library') != null) {
                    ...
                    for (var i = 0; i < filtered_array_gnougn_library.length; i++) {
                        ...
                        if (filtered_array_gnougn_library[i].username.toString().toLowerCase().includes(document.getElementById('element_input_post_username').value)) {
                            document.getElementById('element_ol_firebase_post_username_library').appendChild(_functions2.default.Generate_new_fragment.appendChild(_functions2.default.Generate_new_li(filtered_array_gnougn_library[i])));
                        };
                    }
                };
                ...
                for (var i = 0; i < new_filter_array.length; i++) {
                    ...
                    if (i >= state.data.posts_start && i < state.data.posts_limit) {
                        document.getElementById('element_ol_firebase_library').appendChild(_functions2.default.Generate_new_fragment.appendChild(_functions2.default.Generate_new_li(new_filter_array[i])));
                    };
                };
...
var Handle_EventListeners = function Handle_EventListeners() {
    ...
    if (document.getElementById('element_input_post_types') != null) {
        document.getElementById('element_input_post_types').addEventListener('keydown', function (event) {

            if (event.keyCode == 13) {

                var info = document.getElementById('element_input_post_types').value;
    ...
    if (document.getElementById('element_input_post_tags') != null) {
        document.getElementById('element_input_post_tags').addEventListener('keydown', function (event) {

            if (event.keyCode == 13) {

                var info = document.getElementById('element_input_post_tags').value;
    ...
    if (document.getElementById('element_input_post_categories') != null) {
        document.getElementById('element_input_post_categories').addEventListener('keydown', function (event) {

            if (event.keyCode == 13) {

                var info = document.getElementById('element_input_post_categories').value;
    ...
    if (document.getElementById('element_input_post_subcategories') != null) {
        document.getElementById('element_input_post_subcategories').addEventListener('keydown', function (event) {

            if (event.keyCode == 13) {

                var info = document.getElementById('element_input_post_subcategories').value;
...
var HANDLE_animation_loading_logo = function HANDLE_animation_loading_logo() {
    ...
    (function () {
        ...
        var start_animation = setInterval(function () {
            ...
            var MANIPULATED = document.getElementById('loading_logo_scene');
...
var paint_animation_hand_drops_paint_can = function paint_animation_hand_drops_paint_can() {
    ...
    (function () {
        ...
        var start_animation = setInterval(function () {
            ...
            var MANIPULATED = document.getElementById('paint_animation_hand_holding_paint');
...
var HANDLE_animation_paint_drop_and_splash = function HANDLE_animation_paint_drop_and_splash() {
...
var HANDLE_animation_painting_wall = function HANDLE_animation_painting_wall() {
    ...
    (function () {
        ...
        var start_animation = setInterval(function () {
            ...
            var MANIPULATED = document.getElementById('painting_wall');
...
var HANDLE_animation_hand_pencil_center = function HANDLE_animation_hand_pencil_center() {
    // Accent Layer
    (function () {
        var loop = true;
        var interval = 1;
        var start_animation = setInterval(function () {
            var MANIPULATED = document.getElementById('hand_pencil_center');
...
},{"./partials/state":374,"./partials/functions":372,"./partials/events":373,"./partials/defaults":379,"./partials/components":375,"./partials/elements":376,"./partials/values":377,"./partials/ui":378}],380:[function(require,module,exports) {
