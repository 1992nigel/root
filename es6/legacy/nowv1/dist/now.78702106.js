...
var element_page_left = '\n    <div id="component_app_modal_element_page_left" class="easing_01 transform_translate3d_left0 opacity_0 display_none position_fixed top_0 left_0 bottom_0 height_100vh width_100 z_index_6 margin_auto">\n      <div id="component_app_modal_element_page_left_content" class="position_absolute top_0 left_0 right_0 bottom_0 calc_02vh overflow_hidden box_shadow_bottom_1vh_dark border_01vh_black background_light_yellow_9 z_index_6 margin_auto">\n      \n      </div>\n    </div>\n    ';
...
},{"../index.js":3}],177:[function(require,module,exports) {
'use strict';
...
var Generate_new_li = function Generate_new_li(data) {
  ...
  ELEMENT.children[0].children[2].children[2].addEventListener("click", function (event) {
    ...
    var tour_container = document.getElementById('component_app_modal_element_overlay_top_content');
    ...
    setTimeout(function () {
      ...
      document.getElementById('element_scroll_y_events_pop').addEventListener("scroll", function (event) {
    ...
    setTimeout(function () {
      ...
      document.getElementById('component_app_modal_element_pop_top_content_enter' + number + '').addEventListener('click', function (event) {
        ...
        setTimeout(function () {
          ...
          document.getElementById('element_scroll_y_events_page').addEventListener("scroll", function (event) {
        ...
        setTimeout(function () {
          ...
          document.getElementById('component_app_modal_element_page_top_content_enter' + number + '').addEventListener('click', function (event) {
            ...
            tour_scrolling_container = _elements2.default.element_scroll_y_events('element_scroll_y_events_overlay', tour_content);
            post_tour_from_li_link = '<div style="background-image: url(' + data.feature_image_src + '); background-size: cover;" id="post_tour_from_li_link" class="position_absolute width_100 height_100vh margin_auto">' + tour_scrolling_container + control_container + '</div>';
            ...
            setTimeout(function () {
              ...
              document.getElementById('element_scroll_y_events_overlay').addEventListener("scroll", function (event) {
...
},{"../index.js":3,"./elements":180}],181:[function(require,module,exports) {
'use strict';
...
setTimeout(function () {
    ...
    if (!/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
        ...
        document.getElementById('component_app_body').addEventListener('keydown', function (event) {
            ...
            if (keyCode == 27) {
                console.log('esc');
                _index2.default.HANDLE_animation();
            };
            ...
            if (keyCode == 192) {
                console.log('tildy');
                _index2.default.HANDLE_animation_null();
            };

            // one
            if (keyCode == 49) {
                console.log('1');
                _index2.default.HANDLE_animation_1();
            };
            // two
            if (keyCode == 50) {
                console.log('2');
                _index2.default.HANDLE_animation_2();
            };
            // three
            if (keyCode == 51) {
                console.log('3');
                _index2.default.HANDLE_animation_3();
            };
            // four
            if (keyCode == 52) {
                console.log('4');
                _index2.default.HANDLE_animation_4();
            };
            // five
            if (keyCode == 53) {
                console.log('5');
                _index2.default.HANDLE_animation_5();
            };
            // six
            if (keyCode == 54) {
                console.log('6');
                _index2.default.HANDLE_animation_6();
            };
            // seven
            if (keyCode == 55) {
                console.log('7');
                _index2.default.HANDLE_animation_7();
            };
            // eight
            if (keyCode == 56) {
                console.log('8');
                _index2.default.HANDLE_animation_8();
            };

            // nine
            if (keyCode == 57) {
                console.log('9');
                _index2.default.HANDLE_animation_9();
            };

            // zero
            if (keyCode == 48) {
                console.log('0');
                _index2.default.HANDLE_animation_0();
            };
            ...
            // q
            if (keyCode == 81) {
                _index2.default.HANDLE_animation_q();
            };

            // w
            if (keyCode == 87) {
                _index2.default.HANDLE_animation_w();
            };
        ...
        document.getElementById('component_app_body').addEventListener('mousemove', function (event) {
            ...
            if (state.animation.instances.loaded == true && state.animation.instances.cursor_moved == false) {
                _index2.default.HANDLE_animation_home();
...
},{"../index.js":3}],176:[function(require,module,exports) {
'use strict';
...
var colors = [{
  ...
  id: '',
  classList: '',
  innerHTML: '\n\n    ' + _elements2.default.blog_content() + '\n\n\n\n    '
}, {
...
},{"./elements":180}],178:[function(require,module,exports) {
'use strict';
...
var get_components_handled = function get_components_handled() {
    ...
    // loaded, but hide on hide AND Start or Learn
    {
        ...
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded && !state.animation.instances.start && !state.animation.instances.learn && !state.animation.instances.hide
        // component_state_opacity:  state.animation.instances.loading
    }, {
        component: 'gui_logo_mark',
        //component_state_transform: state.animation.instances.loading,
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded && !state.animation.instances.start && !state.animation.instances.learn && !state.animation.instances.hide
    ...
    {
        component: 'layer_blink',
        //component_state_transform: state.animation.instances.loading,
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded && !state.animation.instances.hide && !state.animation.instances.start && !state.animation.instances.learn && state.ui.interaction.player_1.action.left && !state.ui.interaction.player_1.action.walking && !state.ui.interaction.player_1.action.sitting
        // component_state_opacity:  state.animation.instances.loading
    },

    // stand right
    {
        component: 'standing_right',
        //component_state_transform: state.animation.instances.loading,
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded && !state.animation.instances.hide && (state.animation.instances.start || state.animation.instances.learn) && state.ui.interaction.player_1.action.right && !state.ui.interaction.player_1.action.walking && !state.ui.interaction.player_1.action.sitting
        // component_state_opacity:  state.animation.instances.loading
    },

    // stand left
    {
        component: 'standing_left',
        //component_state_transform: state.animation.instances.loading,
        //component_state_transform_true: 'transform_translate3d_top_100',
        //component_state_transform_false: 'transform_translate3d_top0',
        component_state_display: state.animation.instances.loaded && !state.animation.instances.hide && (state.animation.instances.start || state.animation.instances.learn) && state.ui.interaction.player_1.action.left && !state.ui.interaction.player_1.action.walking && !state.ui.interaction.player_1.action.sitting
...
},{"../index.js":3}],179:[function(require,module,exports) {
'use strict';
...
},{"../index.js":3}],182:[function(require,module,exports) {
'use strict';
...
var Handle_ui = function Handle_ui() {
    ...
    if (document.getElementById('component_app_gui_key') != null) {
        ...
        component_app_gui_key.style = 'height: ' + (state.ui.interaction.key.height - 1) * state.ux.dimensions.height8 + 'px;' + 'width: ' + (state.ui.interaction.key.width - 1) * state.ux.dimensions.width8 + 'px;' + 'top: ' + (state.ui.interaction.key.yaxis - 1) * state.ux.dimensions.height8 + 'px;' + 'left: ' + (state.ui.interaction.key.xaxis - 1) * state.ux.dimensions.width8 + 'px;';
    };
    ...
    if (document.getElementById('component_app_gui_keyhole') != null) {
        ...
        component_app_gui_keyhole.style = 'height: ' + (state.ui.interaction.keyhole.height - 1) * state.ux.dimensions.height8 + 'px;' + 'width: ' + (state.ui.interaction.keyhole.width - 1) * state.ux.dimensions.width8 + 'px;' + 'top: ' + (state.ui.interaction.keyhole.yaxis - 1) * state.ux.dimensions.height8 + 'px;' + 'left: ' + (state.ui.interaction.keyhole.xaxis - 1) * state.ux.dimensions.width8 + 'px;';
    };
    ...
    if (document.getElementById('track_y') != null) {
        document.getElementById('track_y').style = 'top: ' + state.events.mouse.cursor.clientY + 'px; \
        left: ' + 0 + 'px ;';
    };
    ...
    if (document.getElementById('component_app_interaction_hands') != null) {
        ...
        component_app_interaction_hands.style = 'height: ' + state.ux.dimensions.height / 8 + 'px;' + 'width: ' + state.ux.dimensions.width / 8 + 'px;' + 'top: ' + state.events.mouse.drop.clientY + 'px;' + 'left: ' + state.events.mouse.drop.clientX + 'px;';
    };
        ...
        setTimeout(function () {
            ...
            if (document.getElementById('element_input_filter') != null) {
                ...
                for (var i = 0; i < array_gnougn_library.length; i++) {
                    ...
                    // 1 option
                    if (state.data.feature_style == 'all' && state.data.type != 'all' && state.data.category == 'all') {
                        if (array_gnougn_library[i].id.toString().toLowerCase().includes(document.getElementById('element_input_filter').value) && array_gnougn_library[i].type == state.data.type) {
                            filtered_array_gnougn_library.push(array_gnougn_library[i]);
                        };
                    }

                    if (state.data.feature_style != 'all' && state.data.type == 'all' && state.data.category == 'all') {
                        if (array_gnougn_library[i].id.toString().toLowerCase().includes(document.getElementById('element_input_filter').value) && array_gnougn_library[i].feature_style == state.data.feature_style) {
                            filtered_array_gnougn_library.push(array_gnougn_library[i]);
                        };
                    }

                    if (state.data.feature_style == 'all' && state.data.type == 'all' && state.data.category != 'all') {
                        if (array_gnougn_library[i].id.toString().toLowerCase().includes(document.getElementById('element_input_filter').value) && array_gnougn_library[i].category == state.data.category) {
                            filtered_array_gnougn_library.push(array_gnougn_library[i]);
                        };
                    }
                    ...
                    // 2 options
                    if (state.data.feature_style != 'all' && state.data.type == 'all' && state.data.category != 'all') {
                        if (array_gnougn_library[i].id.toString().toLowerCase().includes(document.getElementById('element_input_filter').value) && array_gnougn_library[i].feature_style == state.data.feature_style && array_gnougn_library[i].category == state.data.category) {
                            filtered_array_gnougn_library.push(array_gnougn_library[i]);
                        };
                    }
                    if (state.data.feature_style == 'all' && state.data.type != 'all' && state.data.category != 'all') {
                        if (array_gnougn_library[i].id.toString().toLowerCase().includes(document.getElementById('element_input_filter').value) && array_gnougn_library[i].type == state.data.type && array_gnougn_library[i].category == state.data.category) {
                            filtered_array_gnougn_library.push(array_gnougn_library[i]);
                        };
                    }

                    if (state.data.feature_style != 'all' && state.data.type != 'all' && state.data.category == 'all') {
                        if (array_gnougn_library[i].id.toString().toLowerCase().includes(document.getElementById('element_input_filter').value) && array_gnougn_library[i].type == state.data.type && array_gnougn_library[i].feature_style == state.data.feature_style) {
                            filtered_array_gnougn_library.push(array_gnougn_library[i]);
                        };
                    }
                    ...
                    // 3 options
                    if (state.data.feature_style != 'all' && state.data.type != 'all' && state.data.category != 'all') {
                        if (array_gnougn_library[i].id.toString().toLowerCase().includes(document.getElementById('element_input_filter').value) && array_gnougn_library[i].type == state.data.type && array_gnougn_library[i].category == state.data.category && array_gnougn_library[i].feature_style == state.data.feature_style) {
                            filtered_array_gnougn_library.push(array_gnougn_library[i]);
                        };
                    }
                };
...
var Handle_EventListeners = function Handle_EventListeners() {
    ...
    if (document.getElementById('component_app_scrolling_content') != null) {
        document.getElementById('component_app_scrolling_content').addEventListener("scroll", function (event) {
...
var HANDLE_animation_loading = function HANDLE_animation_loading() {
    ...
    (function () {
        ...
        var start_animation = setInterval(function () {
            ...
            var MANIPULATED = document.getElementById('paint_animation_svg');

            var HANDLE_animation_remove_svg = function HANDLE_animation_remove_svg() {
...
var HANDLE_animation_home = function HANDLE_animation_home() {
...
var HANDLE_animation_gui_logo_type = function HANDLE_animation_gui_logo_type() {
    ...
    (function () {
        ...
        var interval = 1;
        var start_animation = setInterval(function () {
            var MANIPULATED = document.getElementById('gui_logo_type');
...
exports.default = {
    ...
    HANDLE_animation_home: HANDLE_animation_home
};
},{"./partials/state":175,"./partials/functions":177,"./partials/events":181,"./partials/defaults":176,"./partials/components":178,"./partials/elements":180,"./partials/values":179,"./partials/ui":182}],185:[function(require,module,exports) {
