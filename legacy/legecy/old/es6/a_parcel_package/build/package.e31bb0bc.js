...
exports.default = _default;
},{}],"partials/elements.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../index.js":"index.js","./elements":"partials/elements.js"}],"partials/defaults.js":[function(require,module,exports) {
"use strict";
    ...
    setTimeout(function () {
      if (fb_response != null) {
        ...
        for (var i = 0; i < filtered_library.length; i++) {
          ...
          if (categories_matched) {
            if (i < state.data.posts_limit) {
              // console.log(state.data.firebase.gnougn.roster[i]);
              document.getElementById('element_ol_firebase_limited_library').appendChild(_functions.default.Generate_new_fragment.appendChild(_functions.default.Generate_new_li(filtered_library[i])));
            }
        ...
        if (user_logged) {
          if (user_logged) {
            for (var i = 0; i < filtered_library.length; i++) {
              var uploaded_by_user_logged = false;
              ...
              if (uploaded_by_user_logged) {
                // console.log(state.data.firebase.gnougn.roster[i]);
                document.getElementById('element_ol_firebase_library_user_logged').appendChild(_functions.default.Generate_new_fragment.appendChild(_functions.default.Generate_new_li(filtered_library[i])));
              }
        ...
        if (user_logged) {
          if (user_logged) {
            for (var i = 0; i < filtered_library.length; i++) {
              var liked_by_user_logged = false;
              ...
              if (liked_by_user_logged) {
                // console.log(state.data.firebase.gnougn.roster[i]);
                document.getElementById('element_ol_firebase_library_user_liked').appendChild(_functions.default.Generate_new_fragment.appendChild(_functions.default.Generate_new_li(filtered_library[i])));
              }
