        ...
        res.send(`
          ...
          <html id="html" lang="en">
            <head>
              ...
              <title>serve antenuh post ${req.params.id} - ${detail.id}</title>
              ...
              <div id="post" class="">
                ...
                <div id="content" class="display_webkit_box webkit_box_pack_center webkit_box_align">
                  ${detail.content}
                </div>

                <form id="comment_form">
                    <p>comment</p>
                    <input placeholder="comment_input" type="comment_input" id="comment_input" required />
                    <div id="comment_submit" class="">comment_submit</div>
                    <div id="like_submit" class="">like_submit</div>
                </form>
